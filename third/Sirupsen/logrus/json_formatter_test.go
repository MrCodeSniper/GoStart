...
func TestErrorNotLost(t *testing.T) {
	...
	b, err := Format(WithField("error", errors.New("wild walrus")))
	if err != nil {
...
func TestErrorNotLostOnFieldNotNamedError(t *testing.T) {
	...
	b, err := Format(WithField("omg", errors.New("wild walrus")))
	if err != nil {
		t.Fatal("Unable to format entry: ", err)
	}
...
func TestFieldClashWithTime(t *testing.T) {
	...
	b, err := Format(WithField("time", "right now!"))
	if err != nil {
		t.Fatal("Unable to format entry: ", err)
	}
...
func TestFieldClashWithMsg(t *testing.T) {
	...
	b, err := Format(WithField("msg", "something"))
	if err != nil {
		t.Fatal("Unable to format entry: ", err)
	}
...
func TestFieldClashWithLevel(t *testing.T) {
	...
	b, err := Format(WithField("level", "something"))
	if err != nil {
		t.Fatal("Unable to format entry: ", err)
	}
...
func TestFieldClashWithRemappedFields(t *testing.T) {
	...
	b, err := Format(WithFields(Fields{
		"@timestamp": "@timestamp",
		"@level":     "@level",
		"@message":   "@message",
		"timestamp":  "timestamp",
...
func TestJSONMessageKey(t *testing.T) {
	...
	b, err := Format(&Entry{Message: "oh hai"})
	if err != nil {
		t.Fatal("Unable to format entry: ", err)
	}
	s := string(b)
...
func TestFieldDoesNotClashWithCaller(t *testing.T) {
	...
	b, err := Format(WithField("func", "howdy pardner"))
	if err != nil {
		t.Fatal("Unable to format entry: ", err)
	}
