...
func (i *TestExampleImplementation) TheExampleMethod(a, b, c int) (int, error) {
	args := Called(a, b, c)
	return Int(0), errors.New("Whoops")
}
...
func Test_Mock_On(t *testing.T) {
	...
	c := On("TheExampleMethod")
	assert.Equal(t, []*Call{c}, ExpectedCalls)
	assert.Equal(t, "TheExampleMethod", Method)
}
...
func Test_Mock_Chained_On(t *testing.T) {
	...
	assert.Equal(t, expectedCalls, ExpectedCalls)
}
...
func Test_Mock_On_WithArgs(t *testing.T) {
	...
	c := On("TheExampleMethod", 1, 2, 3, 4)

	assert.Equal(t, []*Call{c}, ExpectedCalls)
	assert.Equal(t, "TheExampleMethod", Method)
	assert.Equal(t, Arguments{1, 2, 3, 4}, Arguments)
}
...
func Test_Mock_On_WithFuncArg(t *testing.T) {
	...
	assert.Equal(t, []*Call{c}, ExpectedCalls)
	assert.Equal(t, "TheExampleMethodFunc", Method)
	assert.Equal(t, 1, len(Arguments))
	assert.Equal(t, AnythingOfType("func(string) error"), Arguments[0])
...
func Test_Mock_On_WithVariadicFunc(t *testing.T) {
	...
	assert.Equal(t, []*Call{c}, ExpectedCalls)
	assert.Equal(t, 1, len(Arguments))
	assert.Equal(t, []int{1, 2, 3}, Arguments[0])
...
func Test_Mock_On_WithMixedVariadicFunc(t *testing.T) {
	...
	assert.Equal(t, 1, Arguments[0])
	assert.Equal(t, []int{2, 3, 4}, Arguments[1])
...
func Test_Mock_On_WithVariadicFuncWithInterface(t *testing.T) {
	...
	assert.Equal(t, []*Call{c}, ExpectedCalls)
	assert.Equal(t, 1, len(Arguments))
	assert.Equal(t, []interface{}{1, 2, 3}, Arguments[0])
...
func Test_Mock_On_WithVariadicFuncWithEmptyInterfaceArray(t *testing.T) {
	...
	assert.Equal(t, []*Call{c}, ExpectedCalls)
	assert.Equal(t, 1, len(Arguments))
	assert.Equal(t, expected, Arguments[0])
...
func Test_Mock_On_WithFuncPanics(t *testing.T) {
	...
	assert.Panics(t, func() {
		On("TheExampleMethodFunc", func(string) error { return nil })
	})
}
...
func Test_Mock_On_WithFuncTypeArg(t *testing.T) {
	...
	assert.Equal(t, []*Call{c}, ExpectedCalls)
	assert.Equal(t, 1, len(Arguments))
	assert.Equal(t, AnythingOfType("mock.ExampleFuncType"), Arguments[0])
...
func Test_Mock_Return(t *testing.T) {
	...
	require.Equal(t, []*Call{c}, ExpectedCalls)

	call := ExpectedCalls[0]

	assert.Equal(t, "TheExampleMethod", Method)
	assert.Equal(t, "A", Arguments[0])
	assert.Equal(t, "B", Arguments[1])
	assert.Equal(t, true, Arguments[2])
	assert.Equal(t, 1, ReturnArguments[0])
	assert.Equal(t, "two", ReturnArguments[1])
	assert.Equal(t, true, ReturnArguments[2])
	assert.Equal(t, 0, Repeatability)
	assert.Nil(t, WaitFor)
}
...
func Test_Mock_Return_Run(t *testing.T) {
	...
	assert.Equal(t, "TheExampleMethod3", Method)
	assert.Equal(t, AnythingOfType("*mock.ExampleType"), Arguments[0])
	assert.Equal(t, nil, ReturnArguments[0])
	assert.Equal(t, 0, Repeatability)
	assert.NotEqual(t, nil, WaitFor)
	assert.NotNil(t, Run)
...
func Test_Mock_Return_Once(t *testing.T) {
	...
	assert.Equal(t, "two", ReturnArguments[1])
	assert.Equal(t, true, ReturnArguments[2])
	assert.Equal(t, 1, Repeatability)
	assert.Nil(t, WaitFor)
}
...
func Test_Mock_Return_Twice(t *testing.T) {
	...
	assert.Equal(t, "two", ReturnArguments[1])
	assert.Equal(t, true, ReturnArguments[2])
	assert.Equal(t, 2, Repeatability)
	assert.Nil(t, WaitFor)
}
...
func Test_Mock_Return_Times(t *testing.T) {
	...
	assert.Equal(t, "two", ReturnArguments[1])
	assert.Equal(t, true, ReturnArguments[2])
	assert.Equal(t, 5, Repeatability)
	assert.Nil(t, WaitFor)
}
...
func Test_Mock_Return_Nothing(t *testing.T) {
	...
	assert.Equal(t, "B", Arguments[1])
	assert.Equal(t, true, Arguments[2])
	assert.Equal(t, 0, len(ReturnArguments))
}
...
func Test_Mock_findExpectedCall(t *testing.T) {
	...
	f, c := findExpectedCall("Two", 3)

	if assert.Equal(t, 2, f) {
		if assert.NotNil(t, c) {
			assert.Equal(t, "Two", Method)
			assert.Equal(t, 3, Arguments[0])
			assert.Equal(t, "three", ReturnArguments[0])
		}
	}
...
func Test_Mock_Called(t *testing.T) {
	...
	returnArguments := Called(1, 2, 3)

	if assert.Equal(t, 1, len(Calls)) {
		assert.Equal(t, "Test_Mock_Called", Method)
		assert.Equal(t, 1, Arguments[0])
		assert.Equal(t, 2, Arguments[1])
...
func Test_Mock_Called_blocks(t *testing.T) {
	...
	if assert.Equal(t, 1, len(Calls)) {
		assert.Equal(t, "asyncCall", Method)
		assert.Equal(t, 1, Arguments[0])
		assert.Equal(t, 2, Arguments[1])
		assert.Equal(t, 3, Arguments[2])
	}
...
func Test_Mock_Called_For_Bounded_Repeatability(t *testing.T) {
	...
	returnArguments1 := Called(1, 2, 3)
	returnArguments2 := Called(1, 2, 3)

	if assert.Equal(t, 2, len(Calls)) {
		assert.Equal(t, "Test_Mock_Called_For_Bounded_Repeatability", Method)
		assert.Equal(t, 1, Arguments[0])
		assert.Equal(t, 2, Arguments[1])
		assert.Equal(t, 3, Arguments[2])
...
func Test_Mock_AssertExpectations(t *testing.T) {
	...
	tt := new(testing.T)
	assert.False(t, AssertExpectations(tt))

	// make the call now
	Called(1, 2, 3)

	// now assert expectations
	assert.True(t, AssertExpectations(tt))
...
func Test_Mock_TwoCallsWithDifferentArguments(t *testing.T) {
	...
	args1 := Called(1, 2, 3)
	assert.Equal(t, 5, Int(0))
	assert.Equal(t, 6, Int(1))
	assert.Equal(t, 7, Int(2))
...
func Test_Mock_AssertNumberOfCalls(t *testing.T) {
	...
	Called(1, 2, 3)
	assert.True(t, AssertNumberOfCalls(t, "Test_Mock_AssertNumberOfCalls", 1))

	Called(1, 2, 3)
	assert.True(t, AssertNumberOfCalls(t, "Test_Mock_AssertNumberOfCalls", 2))
...
func Test_Mock_AssertCalled(t *testing.T) {
	...
	assert.True(t, AssertCalled(t, "Test_Mock_AssertCalled", 1, 2, 3))
...
func Test_Mock_AssertCalled_WithAnythingOfTypeArgument(t *testing.T) {
	...
	Called(1, "two", []uint8("three"))

	assert.True(t, AssertCalled(t, "Test_Mock_AssertCalled_WithAnythingOfTypeArgument", AnythingOfType("int"), AnythingOfType("string"), AnythingOfType("[]uint8")))
...
func Test_Mock_AssertCalled_WithArguments(t *testing.T) {
	...
	tt := new(testing.T)
	assert.True(t, AssertCalled(tt, "Test_Mock_AssertCalled_WithArguments", 1, 2, 3))
	assert.False(t, AssertCalled(tt, "Test_Mock_AssertCalled_WithArguments", 2, 3, 4))
...
func Test_Mock_AssertCalled_WithArguments_With_Repeatability(t *testing.T) {
	...
	tt := new(testing.T)
	assert.True(t, AssertCalled(tt, "Test_Mock_AssertCalled_WithArguments_With_Repeatability", 1, 2, 3))
	assert.True(t, AssertCalled(tt, "Test_Mock_AssertCalled_WithArguments_With_Repeatability", 2, 3, 4))
	assert.False(t, AssertCalled(tt, "Test_Mock_AssertCalled_WithArguments_With_Repeatability", 3, 4, 5))
...
func Test_Mock_AssertNotCalled(t *testing.T) {
	...
	assert.True(t, AssertNotCalled(t, "Test_Mock_NotCalled"))
...
func Test_Mock_AssertOptional(t *testing.T) {
	...
	tt1 := new(testing.T)
	assert.Equal(t, true, AssertExpectations(tt1))
	...
	tt2 := new(testing.T)
	assert.Equal(t, true, AssertExpectations(tt2))
	...
	tt3 := new(testing.T)
	assert.Equal(t, true, AssertExpectations(tt3))
}
...
func Test_Arguments_Get(t *testing.T) {
	...
	assert.Equal(t, "string", Get(0).(string))
	assert.Equal(t, 123, Get(1).(int))
	assert.Equal(t, true, Get(2).(bool))
...
func Test_Arguments_Is(t *testing.T) {
	...
	assert.True(t, Is("string", 123, true))
	assert.False(t, Is("wrong", 456, false))
...
func Test_Arguments_Diff(t *testing.T) {
	...
	var diff string
	var count int
	diff, count = Diff([]interface{}{"Hello World", 456, "false"})
...
func Test_Arguments_Diff_DifferentNumberOfArgs(t *testing.T) {
	...
	var diff string
	var count int
	diff, count = Diff([]interface{}{"string", 456, "false", "extra"})
...
func Test_Arguments_Diff_WithAnythingArgument(t *testing.T) {
	...
	var args = Arguments([]interface{}{"string", 123, true})
	var count int
	_, count = Diff([]interface{}{"string", Anything, true})
...
func Test_Arguments_Diff_WithAnythingArgument_InActualToo(t *testing.T) {
	...
	var count int
	_, count = Diff([]interface{}{"string", 123, true})
...
func Test_Arguments_Diff_WithAnythingOfTypeArgument_Failing(t *testing.T) {
	...
	var count int
	var diff string
	diff, count = Diff([]interface{}{"string", 123, true})
...
func Test_Arguments_Diff_WithArgMatcher(t *testing.T) {
	...
	diff, count := Diff([]interface{}{"string", 124, true})
	assert.Equal(t, 1, count)
	assert.Contains(t, diff, `(int=124) not matched by func(int) bool`)

	diff, count = Diff([]interface{}{"string", false, true})
	assert.Equal(t, 1, count)
	assert.Contains(t, diff, `(bool=false) not matched by func(int) bool`)

	diff, count = Diff([]interface{}{"string", 123, false})
...
func Test_Arguments_Assert(t *testing.T) {
	...
	assert.True(t, Assert(t, "string", 123, true))
...
func Test_Arguments_String_Representation(t *testing.T) {
	...
	var args = Arguments([]interface{}{"string", 123, true})
	assert.Equal(t, `string,int,bool`, String())
...
func Test_Arguments_String(t *testing.T) {
	...
	var args = Arguments([]interface{}{"string", 123, true})
	assert.Equal(t, "string", String(0))
...
func Test_MockMethodCalled(t *testing.T) {
	...
	retArgs := MethodCalled("foo", "hello")
